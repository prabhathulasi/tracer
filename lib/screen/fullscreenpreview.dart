...
class FullScreenPreview extends StatefulWidget {
  final ImagePreviewModel image;

  FullScreenPreview({required this.image});

  @override
  State<FullScreenPreview> createState() => _ImagePreviewState();
}

class _ImagePreviewState extends State<FullScreenPreview> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: widget.image.path.endsWith('.pdf')
